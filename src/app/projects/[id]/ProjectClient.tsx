...
export default function ProjectClient() {
    ...
    // Safety check in case params are not available immediately
    if (!project) return null;

    const projectData = portfolioData[lang].projects[project as keyof typeof portfolioData['en']['projects']] as ProjectData; // Fetch or retrieve project data based on the 'project' variable
